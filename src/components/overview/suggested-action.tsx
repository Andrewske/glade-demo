		...
		<>
			<div className="rounded border border-status-danger/20 bg-status-danger/10 p-6">
				...
				<p className="mb-4 text-sm leading-relaxed text-muted-foreground">
					Multiple follow-ups haven't gotten a response. Try a different
					approach:
				</p>
			...
			{/* Toast notification */}
			{toast && (
				<div className="fixed bottom-4 right-4 z-50 rounded border border-border bg-card px-4 py-3 shadow-lg">
