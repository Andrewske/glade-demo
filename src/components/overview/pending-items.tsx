			...
			{allComplete ? (
				...
				<div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
					...
					<div className="rounded border border-border bg-muted p-4">
						...
						<Link
							href="#documents"
							className="text-sm text-link hover:text-link"
						>
							View →
						</Link>
					</div>
					...
					<div className="rounded border border-border bg-muted p-4">
						...
						<div className="mb-3">
							{forms.complete ? (
								...
								<div className="text-sm text-status-warning">{forms.name}</div>
							)}
						</div>

						<Link href="#forms" className="text-sm text-link hover:text-link">
							View →
						</Link>
					</div>
