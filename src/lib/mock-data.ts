	...
	// Maria Garcia - Red status: 3 follow-ups, 12 days no response
	{
		...
		conversations: [
			...
			},
			{
				...
				content:
					"Hi Maria, welcome! I need you to upload your pay stubs and bank statements to proceed with your filing.",
			...
			},
			{
				...
				content:
					"Thank you! I uploaded some documents. Still looking for the pay stubs.",
			...
			},
			{
				...
				type: "ai-followup",
				content:
					"Hi Maria, checking in on those pay stubs. Do you need help locating them?",
			...
			},
			{
				...
				type: "ai-followup",
				content:
					"Maria, we still need your pay stubs and bank statements to move forward. Can you provide an update?",
			...
			},
			{
				...
				type: "ai-followup",
				content:
					"Hi Maria, following up again on the missing documents. Please let me know if you need assistance.",
	...
	// John Smith - Green status: Recent follow-up, on track
	{
		...
		conversations: [
			...
			},
			{
				...
				type: "attorney-message",
				content:
					"Hi John, thanks for choosing our firm. I've reviewed your initial documents and everything looks good so far.",
			...
			},
			{
				...
				type: "attorney-message",
				content:
					"I need you to complete the repayment plan form and provide your last 3 pay stubs.",
			...
			},
			{
				...
				type: "client-response",
				content:
					"Just uploaded the pay stubs. Working on the repayment plan now.",
			...
			},
			{
				...
				type: "ai-followup",
				content:
					"Thanks for the pay stubs! Let me know if you have questions on the repayment plan form.",
				timestamp: daysAgo(5),
			},
		],
		pendingItems: {
		...
		notes: ["Very organized and responsive client"],
	...
	// David Chen - Amber status: Uploaded docs 2 days ago, needs review
	{
		...
		conversations: [
			...
			},
			{
				...
				type: "attorney-message",
				content:
					"Hi David, I need several documents to get started. Please upload your tax returns, pay stubs, and bank statements.",
	...
	// Sarah Johnson - Green status: All good, awaiting final docs
	{
		...
		conversations: [
			...
			},
			{
				...
				type: "attorney-message",
				content:
					"Hi Sarah, great job on getting all your documents in! We're almost ready to file.",
			...
			},
			{
				...
				type: "attorney-message",
				content:
					"Just waiting on the court to process your credit counseling certificate. Should hear back next week.",
			...
			},
			{
				...
				type: "ai-followup",
				content:
					"Quick update: Still waiting on the court. I'll let you know as soon as we get approval.",
				timestamp: daysAgo(3),
			},
		],
		pendingItems: {
	...
	// Robert Wilson - Red status: Overdue invoice + missing docs
	{
		...
		conversations: [
			...
			},
			{
				...
				type: "attorney-message",
				content:
					"Hi Robert, I need your tax returns and an updated list of creditors to proceed.",
			...
			},
			{
				...
				type: "ai-followup",
				content:
					"Robert, we really need those documents to move forward. Also, your invoice is now 30 days past due.",
				timestamp: daysAgo(20),
			},
			{
				id: "conv-27",
				...
				type: "client-response",
				content:
					"I know, I'm sorry. Had some family emergencies. Will try to get everything sorted this week.",
				timestamp: daysAgo(18),
			},
			{
				id: "conv-28",
				...
				type: "ai-followup",
				content:
					"I understand things have been difficult. Let me know if we need to discuss a payment plan for the invoice.",
				timestamp: daysAgo(8),
			},
		],
		pendingItems: {
...
export const MOCK_SUMMARIES: Record<string, MockSummary> = {
	"maria-garcia": {
		summary:
			"Maria is a Chapter 7 bankruptcy client who has been unresponsive for 12 days despite 3 follow-up attempts. She has uploaded 4/6 required documents but is missing pay stubs and bank statements.",
		escalation:
			"Hi Maria, I know gathering documents can be tough. Would a quick 5-minute call help? I can walk you through exactly what we need from your employer for the pay stubs.",
	},
	"john-smith": {
		summary:
			"John is a Chapter 13 client making steady progress. All documents have been uploaded and reviewed. He is currently working on the repayment plan form, with recent follow-up sent 5 days ago.",
	},
	"david-chen": {
		summary:
	...
	"sarah-johnson": {
		summary:
			"Sarah is a model Chapter 13 client with all documents complete and forms filed. Case is waiting on court processing of her credit counseling certificate before final filing.",
	},
	"robert-wilson": {
		summary:
			"Robert has an overdue invoice (45 days past due) and is missing 3 critical documents despite 3 follow-up attempts. He mentioned family emergencies affecting his ability to provide documentation.",
		escalation:
			"Hi Robert, I want to help you through this difficult time. Let's schedule a brief call to discuss a payment plan for the invoice and figure out the easiest way to get those remaining documents. Would tomorrow afternoon work?",
	},
};
